        ...
        <div id="wrapper">
            <form id="register" action="./auth.php" method="POST" autocomplete="on">
                <h1> Celesta Login </h1> 
                    ...
                    ?>
                <p> 
                    <label for="email" class="uname" data-icon="u">Your Celesta ID</label>
                    <input id="email" name="email" required="required" type="text" placeholder="Enter Celesta ID"  />
                </p>
                <p> 
                    <label for="pass" class="uname" data-icon="u">Your NJATH Password</label>
                    <input id="pass" name="pass" required="required" type="password" placeholder="Enter NJATH Password"  />
                </p>
